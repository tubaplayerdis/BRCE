...
// (Event, Protected, BlueprintEvent)
// Parameters:
// EFireMode                               NewMode                                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_CurrentItem_C::UpdateFireMode(EFireMode NewMode)
{
	static class UFunction* Func = nullptr;
